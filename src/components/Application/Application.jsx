...
export default function Application() {
  ...
  return (
    ...
    <div>
        <img src='./images/s-1.png' alt='' className={`slides w-25 m-auto ${styles.round}`}/>
    </div>
    <div>
        <img src='./images/s-2.png' alt='' className={`slides w-25 m-auto ${styles.round}`}/>
    </div>
    <div className=''>
          <img src='./images/s-3.png' alt='' className={`slides w-25 m-auto ${styles.round}`}/>
    </div>
    <div>
        <img src='./images/s-4.png' alt='' className={`slides w-25 m-auto ${styles.round}`}/>
    </div>
    <div>
        <img src='./images/s-5.png' alt='' className={`slides w-25 m-auto ${styles.round}`}/>
    </div>
    <div>
        <img src='./images/s-6.png' alt='' className={`slides w-25 m-auto mb-5 ${styles.round}`}/>
    </div> 
   </OwlCarousel>
      </div> 
      </div>
